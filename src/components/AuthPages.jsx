      ...
      <div style={{ position: "relative" }}>
        <input
          ...
          style={{
            ...
            boxShadow:
              focused && !error ? "0 0 0 3px rgba(34,197,94,0.1)" : "none",
          }}
        />
        {isPassword && (
          <button
    ...
    <PageShell>
      <Card>
        <div style={{ textAlign: "center" }}>
          ...
          <p
            style={{ color: "var(--ink-3)", lineHeight: 1.7, marginBottom: 28 }}
          >
            This link has already been used or has expired. Each link can only
            be used once. If you need to reset your password again, start a new
            request below.
          </p>
          <button
            onClick={() => navigate("/forgot-password")}
      ...
      <Card>
        <div style={{ textAlign: "center" }}>
          ...
          <p
            style={{ color: "var(--ink-3)", lineHeight: 1.7, marginBottom: 28 }}
          >
            Your account has been confirmed. You can now log in and start using
            Avertune.
          </p>
          <button
            onClick={() => navigate("/login")}
